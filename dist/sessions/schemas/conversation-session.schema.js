...
__decorate([
    (0, mongoose_1.Prop)({ required: true, enum: session_types_1.SessionStatus, type: String }),
    __metadata("design:type", String)
...
exports.ConversationSession = ConversationSession = __decorate([
    (0, mongoose_1.Schema)({ collection: 'conversation_sessions', timestamps: false })
], ConversationSession);
exports.ConversationSessionSchema = mongoose_1.SchemaFactory.createForClass(ConversationSession);
exports.ConversationSessionSchema.index({ sessionId: 1 }, { unique: true });
